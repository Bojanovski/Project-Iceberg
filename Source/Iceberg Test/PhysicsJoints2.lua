...
function Start()
	...
	boxMeshPt = GenerateMesh_Box(2.5, 1.0, 1.0)
	...
	boxRgdBodyPt1 = physics.addRigidBody(boxMeshCSPt, true, true, 0.0, 0.0, 0.0)
	...
	physics.addHingeJoint(boxRgdBodyPt1, boxRgdBodyPt2, -1.0, 0.0, 0.0, 1.7, 0.02)
	physics.addHingeJoint(boxRgdBodyPt2, boxRgdBodyPt3, -3.0, 0.0, 0.0, 1.7, 0.02)
	physics.addHingeJoint(boxRgdBodyPt3, boxRgdBodyPt4, -5.0, 0.0, 0.0, 1.7, 0.02)
