#ifndef LIGHTUTILITIES_FX
#define LIGHTUTILITIES_FX
				  ...
				  out float4 ambient, out float4 diffuse, out float4 spec)
{
	...
	// ambient *= spot; // this is not originally commented out
	diffuse *= att;
	spec    *= att;
}
...
//---------------------------------------------------------------------------------------
float CalcShadowFactor(SamplerComparisonState samShadow, Texture2D shadowMap, float4 shadowPosH, float sMapSize)
{
