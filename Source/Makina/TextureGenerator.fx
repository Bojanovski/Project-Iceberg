...
#include "TextureGenerator-PerlinNoise.fx"
#include "TextureGenerator-RidgedMultifractal.fx"
#include "TextureGenerator-RidgedPerlinMix1.fx"
#include "TextureGenerator-2DVoronoi.fx"
#include "TextureGenerator-Functions.fx"
...
technique11 RidgedPerlinMix1Tech3D
{
	pass P0
	{
		SetVertexShader(NULL);
		SetPixelShader(NULL);
		SetComputeShader(CompileShader(cs_5_0, CS3DRidgedPerlinMix1()));
	}
}
...
technique11 SphericalGradientTech3D
{
	pass P0
	{
		SetVertexShader(NULL);
		SetPixelShader(NULL);
		SetComputeShader(CompileShader(cs_5_0, CS3DSphericalGradient()));
	}
}
